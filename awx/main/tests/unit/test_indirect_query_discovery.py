...
class TestListExternalQueries:
    ...
    def test_returns_empty_when_collection_not_installed(self, mock_get_dir):
    ...
    @mock.patch('awx.playbooks.library.indirect_instance_count._get_query_file_dir')
    def test_parses_version_from_filenames(self, mock_get_dir):
        from awx.playbooks.library.indirect_instance_count import list_external_queries
        ...
        mock_get_dir.return_value = mock_queries_dir
    ...
    @mock.patch('awx.playbooks.library.indirect_instance_count._get_query_file_dir')
    def test_skips_invalid_versions(self, mock_get_dir):
        from awx.playbooks.library.indirect_instance_count import list_external_queries
